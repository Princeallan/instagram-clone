            ...
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                <div class="flex items-center bg-black w-full">
                    <img
                        ...
                        src="https://picsum.photos/id/55/800/820"
                    >
                </div>
                ...
                <div class="md:max-w-[500px] w-full relative">
                    <div class="flex items-center justify-between p-3 border-b">
                        <div class="flex items-center">
                            <img class="rounded-full w-[38px] h-[38px]" src="https://picsum.photos/id/55/300/320">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 font-extrabold text-[15px]">
                                        comment Username
                                        <span class="font-light text-gray-700 text-sm"> created_at </span>
                                    </div>
                                </div>
