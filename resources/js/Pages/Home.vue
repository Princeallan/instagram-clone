        ...
        <div class="mx-auto lg:pl-0 md:pl-[80px] pl-0">
            ...
            >
                <Slide v-for="slide in 10" :key="slide">
                    <Link href="/"
                        ...
                        <img class="rounded-full w-[56px] h-[56px] -mt-[1px]" src="https://picsum.photos/id/55/300/320">
            ...
            <div id="Posts" class="px-4 max-w-[600px] mx-auto mt-10">
                <div class="flex items-center justify-between py-2">
                    <div class="flex items-center">
                        <Link href="/" class="flex items-center">
                            <img class="rounded-full w-[38px] h-[38px]" src="https://picsum.photos/id/54/300/320">
                            <div class="ml-4 font-extrabold text-[15px]"> Username</div>
                        </Link>
                ...
                <div class="bg-black rounded-lg w-full min-h-[400px] flex items-center">
                    <img class="mx-auto w-full" src="https://picsum.photos/id/53/300/320" />
                </div>

                <LikesSection />

                <div class="text-black font-extrabold py-1">10 likes</div>
                <div>
                    <span class="text-black font-extrabold"> Username </span>
                    Post Text
                </div>
                <button
